...
Архитектура системы включает 5 основных модулей, каждый из которых отвечает за выполнение ключевых функций. Описание модулей представлено ниже:
